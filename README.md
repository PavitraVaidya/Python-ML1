...
* *Training*: your provided code uses pretrained models for inference. If you need to "train your own model" , follow these steps:
...
* Place triples.csv in the working directory.
